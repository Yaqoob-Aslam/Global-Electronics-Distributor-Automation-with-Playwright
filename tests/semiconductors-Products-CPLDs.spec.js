...
test.describe.serial('Enrgtech - Global Electronics Distributor', () => {
  ...
  async function completeCheckoutProcess(productNumber, currentProductUrl) {
    try {
      ...
      //     }
      //   } else {
      //     console.log('⚠ "As a person" option not found with XPath, trying alternative selectors...');
      ...
      //           // Try to select "As a person" by text
      //           await dropdown.selectOption({ label: /person/i });
      //           console.log('✓ Selected "As a person" by label');
      //           dropdownFound = true;
      //           break;
      //         }
      //       } catch {
